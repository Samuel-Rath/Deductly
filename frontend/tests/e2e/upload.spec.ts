    ...
    await page.route('**/upload', async (route) => {
      await route.fulfill({
        ...
        body: JSON.stringify({
          ...
          report_data: {
            summary: {
              totalDeductible: 638.95,
              totalNeedsReview: 312.40,
              totalExcluded: 0,
              confidenceDistribution: { high: 1, medium: 1, low: 1 },
            },
            candidates: [
              { id: '1', merchant: 'Officeworks', amount: 89.95, category: 'Home Office', confidence: 0.74, date: '2024-07-15', description: 'Officeworks PTY LTD' },
              { id: '2', merchant: 'CPA Australia', amount: 549.00, category: 'Professional', confidence: 0.91, date: '2024-07-20', description: 'CPA AUSTRALIA MEMBERSHIP' },
            ],
            excluded: [],
          },
        }),
