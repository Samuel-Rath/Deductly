...
describe('Privacy Page', () => {
  ...
  it('explains the data processing pipeline steps', () => {
    renderPrivacy()
    expect(screen.getByRole('heading', { name: /How We Process Your Data/i })).toBeInTheDocument()
  ...
  it('documents automatic redaction of sensitive identifiers', () => {
    renderPrivacy()
    expect(screen.getByRole('heading', { name: /Automatic Redaction/i })).toBeInTheDocument()
  ...
  it('lists user rights and security measures', () => {
    ...
    // Security heading "9. Security" — use substring match via regex
